...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_gu2.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/gu2/gu_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">괌 4박 5일#워터파크 강자#PIC 슈페리어룸#전식호텔식#시내관광#에메랄드밸리#소그룹</p><!-- 쳌 상품명-->
                            </div> 
                            <div class="text_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">2,040,000</strong><!-- 쳌 가격1-->
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">2,040,000</span><span>원</span></td>
												<td><span class="price">740,000</span><span>원</span></td>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">괌 NEW 시내관광 포함</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>① 사랑의 절벽, 아가나 대성당, 스페인 광장, 에메랄드밸리 등을 돌아보는 시내관광 일정 포함!<br>
														② 스페셜 포함 1: 사랑의 절벽에서 객실당 자물쇠 1개 제공<br>
														③ 스페셜 포함 2 : 아가나대성당에서 객실당 리얼 코코넛 주스 1개 제공<br>
													</li>
												</ul>
												...
												<ul class="list_bul nostyle">
													<li>① 괌 현지에 운영사무실이 있어 더욱 안전하고 차별화된 서비스 제공<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">2,040,000<span>원</span></p>
