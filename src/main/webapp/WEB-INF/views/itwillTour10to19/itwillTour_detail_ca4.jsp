...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ca4.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca4/ca_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">캐나다 항공 일주 10일#베스트셀러#국내선2회#퀘백숙박#나이아가라폭포뷰UP/로키</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">#MD추천 # 캐나다 BEST스테디셀러 #국내선 2회 탑승으로 시간 절약 #가장 완벽한 캐나다 여행 #밴쿠버 #빅토리아 #로키 #퀘벡 #나이아가라 #토론토 </p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">6,099,000</strong><!-- 쳌 가격1-->
								...
								<dl>
									<dt>일정</dt>
										<dd>
											...
											<p class="item_text air_info"><span>출발 : 2021.05.03(월) 13:35 → 2021.05.03(월) 16:50 / KE0923 / 총 09시간 15분 소요</span></p>
											<p class="item_text air_info"><span>도착 : 2021.05.08(토) 21:20 → 2021.05.08(토) 15:05 / KE0926 / 총 10시간 45분 소요</span></p>
										</dd>
									<dt>여행도시</dt>
										<dd>
											<span>밴쿠버-빅토리아-밴프-레이크 루이스-몬트리올-퀘벡-몬트리올-킹스톤-나이아가라 폭포-토론토 </span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
							...
							<div class="cont_unit price">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">6,099,000</span><span>원</span></td>
												<td><span class="price">5,178,046</span><span>원</span></td>
												<td><span class="price">1,829,700</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="option_wrap">
									...
									<div class="right_cont mileage_save">
										<a href="#none" class="txt arrow_r">하나투어 마일리지<em>31,900<span class="icn mileage em"></span></em>적립예정</a>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">인기상품엔 이유가 있다!</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- MD 강력추천, 캐나다 주요 관광지 A-Z까지 한번에!<br>
														[빅토리아/밴쿠버/로키/퀘벡/나이아가라/몬트리올/천섬/토론토]<br>
														<br>
														- 스탠리 공원/게스타운/캐나다 플레이스 등 밴쿠버 시내관광<br>
														- 그랜빌 아일랜드 퍼블릭 마켓 자유시간<br>
														- 다양한 종류의 정원들이 모여있는 사진명소 빅토리아 부차드 가든<br>
														- 영국풍의 건물들이 멋진 항구도시 빅토리아<br>
														- 세계 10대 절경 레이크 루이스<br>
														- 세계에서 가장 큰 애써배스카 빙하 위에 직접 오르는 '설상차' 탑승<br>
														- 정상에서 느껴보는 또 다른 로키 '곤돌라' 탑승<br>
														- 가이드의 해박한 설명과 함께 하는 올드퀘벡 관광<br>
														- 몬트리올/토론토 시내관광<br>
														- 수천 개의 섬들이 보여주는 아기자기한 자연풍경, 천섬 크루즈<br>
														- 세계 3대 폭포 나이아가라 즐기기 (혼블로어 크루즈 탑승, 테이블락 관광 등)<br>
														- 아이스와인의 명소! 나이아가라 와이너리 방문/시음<br>
														- 스카이론 타워 전망대 관광<br>
													</li>
												</ul>
												...
												<div class="text_wrap sml">
													<strong class="tit">모객 상황에 따라 최대 3~4회 가이드 및 차량 변경이 있을 수 있습니다.</strong>
												</div>
											...
											<div class="js_acc">
												...
												<div class="inr">
													...
													<a href="#acc_con0" class="nojq header daylist">
														<span class="tit_left"><strong>1일차</strong>05/03(월)</span>
														<strong>인천,시애틀</strong>
														<p>-</p>
													</a>
                                                                   	...
                                                                   	<div id="add_hotel_0" class="view">
                                                                   		<div class="additional_list">
                                                                   			<div class="link_list ing">
                                                                   				<strong class="tit">데이즈 인 바이 원덤 서리</strong>
                                                                   				<p class="wrap_star">
												...
												<div class="inr">
													...
													<a href="#acc_con1" class="nojq header daylist">
														<span class="tit_left"><strong>2일차</strong>05/04(화)</span>
														<strong>벤쿠버</strong>
														<p>브라이덜 폭포, 쿠르니 국립공원</p>
													</a>
																		...
																		<div class="card_mngr">
    																		<div class="card_unit type3">
        																		<div class="_tit title">
        																			<strong class="eps">밴쿠버 관광</strong>
        																		</div>
        																		
        																		<div class="_tit_comt sub"><p class="eps"><b>브라이덜 폭포</b><br>면사포를 쓰고 있는 수줍은 신부의 모습을 간직한 아름다운 폭포입니다.</p></div>
        																		<div class="_info_section cont_box">
            																		...
            																		<div class="_txt_cont txt_conts">
            																			<div>브라이덜 폭포(bridal veil falls)는 떨어지는 폭포수의 모습이 마치 신부의 면사포와 같다고 해서 붙여진 이름입니다. 이름처럼 마치 수줍어하는 신부와 같은 아름다운 풍경을 자랑하는 이 폭포는 밴쿠버에서 차로 한 시간 반 정도 떨어져 있으며 둘러보는 데 30분 정도의 시간이 소요되는 작은 규모의 폭포입니다.<br>
																							</div>
																					</div>
        																		...
        																		<div class="_tit_comt sub"><p class="eps"><b>쿠트니 국립공원</b><br></p></div>
        																		<div class="_info_section cont_box">
            																		<div class="_thumb thumb">
            																			<div class="img_list">
            																				<img src="<%=cp %>/resources/image/list/detail/ca1/ca_6_hh.jpg">
            																				</div>
            																		</div>
            																		<div class="_txt_cont txt_conts">
            																			<div>다른 국립공원들에 비해 상대적으로 덜 알려져 있는 곳으로 사실 여행객보다는 현지 사람들에게 더 인기 있는 국립공원입니다. 기간이 길다면 밴프 국립공원과 워터튼 국립공원을 여행하시면서 중간에 들르시기 좋습니다. 쿠트니라는 이름은 원주민어로 '고개를 넘어온 사람들'이라는 뜻을 가지고 있으며, 과거 원주민들은 실제로 로키를 넘어 들소 사냥을 다녔다고 합니다. 마블 캐년을 비롯해 싱클레어 캐년, 페인트 팟 등을 보실 수 있고, 라듐 핫 스프링스에서는 온천도 즐기실 수 있습니다.<br>
																							</div>
																					</div>
            																		<div class="_local_info txt_box disc"></div>           
            																		<div class="custom_tag_a">
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">6,099,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">5,178,046원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,829,700원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">6,099,000<span>원</span></p>
