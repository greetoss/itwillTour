...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ne4.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ne4/ne_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">러시아+발틱3국(에스토니아,라트비아,리투아니아) 9일 #5성급호텔 3박 #미식 여행 #중간항공 1회 탑승</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">화려한 문화유산과 볼거리를 자랑하는 러시아와 유럽 속 순결한 세자매 에스토니아, 라트비아, 리투아니아를 여행하는 상품입니다.</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">4,990,000</strong><!-- 쳌 가격1-->
						...
						<div class="inr">
							...
							<div class="cont_unit summary">
								...
								<dl>
									...
									<dt>여행도시</dt>
										<dd>
											<span>모스크바-빌뉴스-바우스카-샤울레이-트라카이-리가-탈린-상트페테르부르크 </span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
							...
							<div class="cont_unit price">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">4,990,000</span><span>원</span></td>
												<td><span class="price">4,491,000</span><span>원</span></td>
												<td><span class="price">499,000</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="option_wrap">
									...
									<div class="right_cont mileage_save">
										<a href="#none" class="txt arrow_r">하나투어 마일리지<em>99,800<span class="icn mileage em"></span></em>적립예정</a>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">모스크바 핵심포인트♥</strong>
												</div>
												<ul class="list_bul nostyle">
												...
												<div class="text_wrap sml">
													<strong class="tit">발틱3국 핵심포인트♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>-탈린 1포병대 타원(Kiek in de Kok)'내부관광<br>
														-진정한 중세의 향기를 맡을 수 있는 '투라이다성' 내부관광<br>
														-아름다운 호수안에 있는 '트라카이성' 내부관광<br>
														-아름다운 룬달레 궁전 내부관광<br>
														-수많은 십자가가 있는 샤울레이 십자가 언덕<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">발틱의 맛</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>트립어드바이저에 상위권으로 랭크되어 있는 OLDE HANSA 중세식+ 시나몬 아몬드<br>
													</li>
												</ul>
												...
												<div class="text_wrap sml">
													<strong class="tit">북유럽지역은 모두 포함으로 선택관광이 없고 러시아지역만 있습니다.</strong>
												</div>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">4,491,000원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">4,990,000<span>원</span></p>
