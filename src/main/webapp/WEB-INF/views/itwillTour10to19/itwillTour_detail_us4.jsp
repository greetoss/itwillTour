...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_us4.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us4/us_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">뉴욕 6일#맨해튼 숙박#NO쇼핑#NO옵션#NO가이드경비</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">미동부 최대 도시 뉴욕! 한 도시 여유롭게 여행하기 </p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">5,799,000</strong><!-- 쳌 가격1-->
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">5,799,000</span><span>원</span></td>
												<td><span class="price">4,929,143</span><span>원</span></td>
												<td><span class="price">1,739,700</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">넉넉한 관람시간과 자유일정</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>뉴욕 현대 미술관<br>
														메트로폴리탄 미술관<br>
												...
												<div class="text_wrap sml">
													<strong class="tit">뉴욕의 별미</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 뉴욕 3대 피자 중 하나인 롬바르디스 피자<br>
														- 우리 입맛에도 딱인 뉴요커의 베트남식 맛집, 사이공 마켓<br>
														- 멋진 뉴욕 야경을 보며 즐기는 선상 뷔페<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">5,799,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">4,929,143원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,739,700원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">5,799,000<span>원</span></p>
