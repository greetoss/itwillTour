...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ca1.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca1/ca_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">캐나다 로키/시애틀 7일#인기상품#일급호텔#로키3대국립공원</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">미국 북서부 아름다운 도시 시애틀과 수려한 경관을 자랑하는 밴쿠버, 캐나다의 대자연이 빚어낸 로키 국립공원의 절경을 감상할 기회!!</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">3,190,000</strong><!-- 쳌 가격1-->
						...
						<div class="inr">
							...
							<div class="cont_unit summary">
								...
								<dl>
									...
									<dt>여행도시</dt>
										<dd>
											<span>밴쿠버-살몬 암-레벨스톡 (BC)-호프 (BC)-쿠트니-레이크 루이스 (AB)-캔모어 (AB)-시애틀-밴프</span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">3,190,000</span><span>원</span></td>
												<td><span class="price">2,711,500</span><span>원</span></td>
												<td><span class="price">957,000</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">로키 3大 국립공원 방문</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 밴프 국립공원, 자스퍼 국립공원, 쿠트니 국립공원<br>
													</li>
												</ul>
												...
												<ul class="list_bul nostyle">
													<li>- 영롱한 에메랄드 빛깔의 아름다운 호수<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">로키 핵심 관광</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 캐나다의 보석! 로키의 핵심만 쏙쏙 관광하는 특별한 여행<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">2,711,500원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">957,000원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">3,190,000<span>원</span></p>
