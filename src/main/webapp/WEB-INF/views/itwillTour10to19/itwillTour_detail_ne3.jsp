...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ne3.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ne3/ne_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">러시아 일주 6일 #쉼표in유럽 #준특급 호텔 #삽산열차 1등석 #운하유람선</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">혁명의 도시에서 정치,경제,문화의 중심지로 화려하게 변화하고 있는 모스크바와 예술의 도시 상트 페테르부르크를 관광하며 찬란했던 과거의 문명과 역동적인 오늘을 모습을 엿볼 수 있는 러시아일주 상품입니다.</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">3,590,000</strong><!-- 쳌 가격1-->
							...
							<div class="cont_unit price">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">3,590,000</span><span>원</span></td>
												<td><span class="price">3,231,000</span><span>원</span></td>
												<td><span class="price">359,000</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="option_wrap">
									...
									<div class="right_cont mileage_save">
										<a href="#none" class="txt arrow_r">하나투어 마일리지<em>71,800<span class="icn mileage em"></span></em>적립예정</a>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">모스크바관광 핵심포인트♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>-러시아의 심장부 '크레믈린궁 내부 관람'<br>
														-러시아 우주산업의 메카 '우주박물관 내부입장'<br>
														-러시아 명작이 모여있는 곳, 트레치야코프 미술관<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">상트페테르부르크관광 핵심포인트♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>-러시아 문화의 보고 '에르미타쥬 박물관 내부입장'<br>
														-페트로드보레츠의 대규모 정원인 '여름궁전 분수정원'<br>
														-세계에서 세번째로 큰 규모인 '성이삭성당 내부입장'<br>
														-화려한 외관과 내부를 자랑하는 '피의사원 내부입장'<br>
														-상트페테르부르크 시민들이 사랑하는 '문학카페(Literary Cafe)'<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">하나투어의 노르웨이 핵심포인트 ♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 베르겐 시내를 한눈에 볼수 있는 '플뢰엔산 케이블카' 탑승<br>
														- 로맨틱열차 '플롬라인' 탑승<br>
														- 노르웨이 관광의 핵심 '피요르드 유람선' 탑승 관광<br>
														- '브릭스달 빙하' 전동차 탑승 관광<br>
														- 노르웨이 대표화가 뭉크의 작품을 볼수 있는 뭉크 미술관 내부 관광<br>
														- 노르웨이 3박 4일 한국인 가이드 동행 (★타사 비교필수)<br>
														※한국인 가이드가 없는 경우가 많습니다.<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">3,231,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">359,000원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">3,590,000<span>원</span></p>
