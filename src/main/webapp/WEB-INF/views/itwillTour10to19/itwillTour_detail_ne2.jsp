...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ne2.js"></script>
					...
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ne2/ne_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
						...
						<div class="inr right">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">7,590,000</strong><!-- 쳌 가격1-->
							...
							<div class="cont_unit price">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">7,590,000</span><span>원</span></td>
												<td><span class="price">6,831,000</span><span>원</span></td>
												<td><span class="price">759,000</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="option_wrap">
									...
									<div class="right_cont mileage_save">
										<a href="#none" class="txt arrow_r">하나투어 마일리지<em>151,800<span class="icn mileage em"></span></em>적립예정</a>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">하나투어의 스웨덴 핵심포인트 ♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 스톡홀름 '시청사' 내부 관광<br>
														- 스웨덴 왕실의 호화 전함 바사호가 전시된 '바사 박물관' 내부 관광<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">하나투어의 덴마크 핵심포인트 ♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- '로젠버그성 보석관' 내부 관광<br>
														- 프레데릭성의 정원 관광<br>
														- 안데르센이 영감을 얻은 뉘하운 운하 관광<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">하나투어의 핀란드 핵심포인트 ♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- '템펠리아우키오' (암석교회) 내부 관광<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">하나투어의 러시아 핵심포인트 ♥</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 모스크바의 심장 '크렘린 궁전' 내부 관광<br>
														- 모스크바 '구세주 그리스도 대성당' 관광<br>
														- 상트 페테르부르크 '성 이삭성당' 내부 관광<br>
														- 상트 페테르부르크 '여름궁전 분수정원' 관광<br>
														- 세계 3대 박물관인 에르미타쉬 국립박물관 내부 관광<br>
													</li>
												</ul>
