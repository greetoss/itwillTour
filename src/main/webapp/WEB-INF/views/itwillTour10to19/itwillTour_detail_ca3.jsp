				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca3/ca_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">캐나다 밴쿠버/빅토리아/나나이모/토피노 7일# 맥밀런 주립공원</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">세계에서 살기좋은 도시 밴쿠버, 빅토리아 그리고 자연을 느낄 수 있는 캐나다 서부로 여해을 떠나요~!</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">6,223,600</strong><!-- 쳌 가격1-->
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">6,223,600</span><span>원</span></td>
												<td><span class="price">5,295,100</span><span>원</span></td>
												<td><span class="price">1,857,000</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">우리끼리만 즐기는 맞춤 여행!</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 다른 일행과 같이 다니는 여행이 아닌, 우리 일행만 단독 일정&차량으로 진행되는 여행입니다.<br>
														- 4명이상 모이면 출발 가능! ( 2인 출발의 경우 추가요금 발생. 별도 문의 )<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">빅토리아 부차트 가든 투어</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 빅토리아 투어 중 가장 많은 인기를 끌고있는 빅토리아&부차트가든 투어가 포함되어 있습니다.<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">6,223,600원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">5,295,100원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,857,000원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">6,223,600<span>원</span></p>
