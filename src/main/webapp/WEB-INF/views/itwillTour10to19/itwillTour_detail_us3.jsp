...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_us3.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us3/us_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">미동부 캐나다 일주 12일#나이아가라특급호텔 폭포뷰#9대도시#아울렛 쇼핑#하버드대학#특식</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">동부 핵심 관광 포함된 일정</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">6,299,000</strong><!-- 쳌 가격1-->
						...
						<div class="inr">
							...
							<div class="cont_unit summary">
								...
								<dl>
									...
									<dt>여행도시</dt>
										<dd>
											<span>뉴욕-토론토-워싱톤-필라델피아-해리스버그-보스톤-나이아가라 폭포-우드베리</span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">6,299,000</span><span>원</span></td>
												<td><span class="price">5,354,150</span><span>원</span></td>
												<td><span class="price">1,889,700</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">6,299,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">5,354,150원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,889,700원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">6,299,000<span>원</span></p>
