...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_ca2.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/ca2/ca_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">캐나다 항공일주 8일#베스트셀러#엄선된 일급호텔#나이아가라2박#특식</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">#스테디셀러 #베스트셀러 #고객선정 고객만족도 우수상품! #업계유일 나이아가라 2박 숙박 #캐나다 핵심 여행</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">4,899,000</strong><!-- 쳌 가격1-->
						...
						<div class="inr">
							...
							<div class="cont_unit summary">
								...
								<dl>
									...
									<dt>여행도시</dt>
										<dd>
											<span>밴쿠버-캘거리-밴프-캔모어-캘거리-토론토-나이아가라 폭포-토론토</span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">4,899,000</span><span>원</span></td>
												<td><span class="price">4,154,351</span><span>원</span></td>
												<td><span class="price">1,469,700</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">캐나다 최대 도시 토론토 100배 즐기기</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 토론로에서 즐기는 자유시간! 구석구석 아름다운 토론토를 자유롭게 느껴보세요<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">로키 곤돌라 탑승</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 곤돌라를 타고 올라가 느껴보는 웅장한 대자연 로키<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">세계 10대 절경 레이크 루이스</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>- 영롱한 빛을 발하는 로키의 매혹적인 호수<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">4,899,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">4,154,351원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,469,700원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">4,899,000<span>원</span></p>
