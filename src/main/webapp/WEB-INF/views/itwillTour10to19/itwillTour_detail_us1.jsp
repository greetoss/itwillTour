...
<script type="text/javascript" src="<%=cp%>/resources/js/detail_us1.js"></script>
				...
				<div class="inr wide">
					<div class="ly_wrap prod_brief">
							...
							<div class="swiper-container prevNext pager v-swiper2 swiper-container-initialized swiper-container-horizontal">
								<div id="slide" class="swiper-wrapper" style="transform: translate3d(-674px, 0px, 0px); transition-duration: 0ms;">
									...
									<div class="swiper-slide swiper-slide-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_1_hh.jpg" title="" data-src="" alt=""><!-- 쳌 사진-->
									</div>
									<div class="swiper-slide swiper-slide-next" style="width: 674px;" data-swiper-slide-index="1">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_2_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="2">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_3_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide" style="width: 674px;" data-swiper-slide-index="3">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_4_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate-prev" style="width: 674px;" data-swiper-slide-index="4">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_5_hh.jpg" title="" data-src="" alt="">
									</div>
									<div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 674px;" data-swiper-slide-index="0">
										<img src="<%=cp %>/resources/image/list/detail/us1/us_1_hh.jpg" title="" data-src="" alt="">
									</div>
								</div>
						...
						<div class="inr right">
                            ...
                            <div>
                            	<p style="font-size: 26px;">미서부 그랜드서클 12일#8대캐년#일급호텔#3대도시#요세미티#캐년산책</p><!-- 쳌 상품명-->
                            </div>
                            <div class="text_wrap">
                            	<strong class="item_title">${dto.subject }</strong>
                            	<p class="txt exclam">미서부 8대캐년을 한 번에 모두 즐길 수 있는 미서부 패키지 여행의 완결판 상품입니다.</p>
                            </div>
                            <div class="option_wrap">
                            ...
                            <div class="price_group">
                            	<p class="tag">성인 1인</p>
                            	<strong class="price">5,199,000</strong><!-- 쳌 가격1-->
						...
						<div class="inr">
							...
							<div class="cont_unit summary">
								...
								<dl>
									...
									<dt>여행도시</dt>
										<dd>
											<span>로스앤젤레스-자이언 캐년-브라이스-아치스캐년-그린리버-요세미티-샌프란시스코</span>
										</dd>
									<dt>예약현황</dt>
										<dd class="state">
							...
							<div class="cont_unit price">
								...
								<div class="tbl">
									<table class="type1">
										...
										<tbody>
											<tr>
												<td>기본상품</td>
												<td><span class="price">5,199,000</span><span>원</span></td>
												<td><span class="price">4,357,409</span><span>원</span></td>
												<td><span class="price">1,516,282</span><span>원</span></td>
											</tr>
										</tbody>
									</table>
								</div>
								<div class="option_wrap">
									...
									<div class="right_cont mileage_save">
										<a href="#none" class="txt arrow_r">하나투어 마일리지<em>103,980<span class="icn mileage em"></span></em>적립예정</a>
								...
								<div class="js_tabs type3 keypoints link no_division">
									...
									<div class="panels cont_keypoints" style="">
										<div id="point01" class="item item01">
												...
												<div class="text_wrap sml">
													<strong class="tit">혜택 가득 챙겨 떠나자!</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>① 라스베이거스 준특급 호텔 숙박<br>
														② 인디언 지프 투어 탑승 포함<br>
													</li>
												</ul>
												
												<div class="text_wrap sml">
													<strong class="tit">항공사 예약부도위약금(No-Show Penalty) 안내</strong>
												</div>
												<ul class="list_bul nostyle">
													<li>① 탑승일 이전에 예약 취소를 하지 않고 당일 취소하거나,<br>
														수속을 마친 후라도 개인 사유로 탑승을 하지 않은 승객에게는 수수료가 부과(약 12만원)됩니다.<br>
														② 일정 변경이나 취소 발생 시 예약하신 여행사 또는 인솔자(가이드)에게 반드시 사전 연락 주시기 바랍니다.<br>
													</li>
												</ul>
							...
							<div class="cont_unit js_sticky" style="right: auto; left: 0px;">
									...
									<ul>
										...
										<li>
											<p class="tit">
												...
												<span class="price">5,199,000원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">4,357,409원</span>
											</p>
										...
										<li>
											...
											<p class="tit">
												...
												<span class="price">1,516,282원</span>
											</p>
								...
								<div class="cont_wrap">
									...
									<div class="total_money">
										...
										<p id="price" class="price">5,199,000<span>원</span></p>
